...
xlabel = sprintf("Date of onset of symptoms from %s to %s", min(plague2_data$onsetDate_new), max(plague2_data$onsetDate_new)))
...
**Data needs:**  
We need genotypic data on confirmed cases to study transmission patterns in the dataset and GIS data to study the geographical distribution of the cases in Himachal Pradesh, India.