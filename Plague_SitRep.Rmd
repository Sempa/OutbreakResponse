...
```{r fig1, cache = FALSE, echo = FALSE, fig.height = 4, warning=FALSE, message=FALSE, fig.align = 'left', results='asis', fig.cap = 'Distribution of cases the pneumonic plague outbreak in\n Northeast India 12 Oct 2019 - 09 Dec 2019'}
##distribtuion by status
inc_object <- incidence(plague2_data_update$onsetDate, groups = plague2_data_update$status)

my_theme <- theme_bw(base_size = 12) +
 theme(panel.grid.minor = element_blank()) +
 theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5, color = "black"))
plot(inc_object, border = "white") +
 my_theme +  scale_fill_discrete(name = 'Status')+
...
```{r fig2, cache = F, echo=FALSE, fig.height = 4, fig.align = 'left', results='asis', message=FALSE, warning=FALSE, fig.cap = 'Gender distribution of the pneumonic plague outbreak in\n Northeast India 12 Oct - 09 Dec 2019'}
##gender distribution
...
```{r fig3, cache = F, echo=FALSE, fig.height = 4, fig.align = 'left', results='asis', warning = FALSE, fig.cap = 'Age distribution of the pneumonic plague outbreak in\n Northeast India 12 Oct - 09 Dec 2019'}
...
There were no gender differences in mortality, i.e. `r table(plague2_data_update$sex,plague2_data_update$death_stri)[3]` in females vs `r table(plague2_data_update$sex,plague2_data_update$death_stri)[4]` in males (p.value=`r (prop.test(x=c(18,19),n=c(89,64), alternative = "two.sided", correct = TRUE))$p.value`). The highest number of deaths, i.e. 4 deaths, in a single day, reported occured on `r (plague2_data_update$deathDate[which(!is.na(plague2_data_update$deathDate),)])[which.max(tabulate(match(plague2_data_update$deathDate, plague2_data_update$deathDate[which(!is.na(plague2_data_update$deathDate),)])))]` (figure 4).
```{r fig4, cache = F, echo=FALSE, fig.height = 4, fig.align = 'left', results='asis', warning=FALSE, fig.cap = 'Gender distribution of the pneumonic plague outbreak in\n Northeast India 12 Oct - 09 Dec 2019'}
##mortality
# mort_sex <- table(plague2_data_update$sex,plague2_data_update$death_stri)
# kable(mort_sex)%>%
#   kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
##testing for difference in mortlity between females and males
diff_sex <- prop.test(x=c(18,19),n=c(89,64), alternative = "two.sided", correct = TRUE)
