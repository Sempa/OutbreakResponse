...
```{r fig5, cache = F, echo=FALSE, fig.height = 4, fig.align = 'left', results='asis', warning=FALSE, fig.cap = '**Figure 2: Mortality due to pneumonic plague outbreak in Northeast India 12 Oct - 09 Dec 2019**'}
